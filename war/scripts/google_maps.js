var maakond_keskus = {
	...
	laane : {loc: new google.maps.LatLng(58.948592,23.536835), name: "LÃ¤Ã¤nemaa", 		  party: 'Info puudub', 			perc: 'N/A' , enabled: true},
	parnu : {loc: new google.maps.LatLng(58.386418,24.496422), name: "PÃ¤rnumaa", 		  party: 'Info puudub', 			perc: 'N/A' , enabled: true},
	rapla : {loc: new google.maps.LatLng(59.005744,24.794254), name: "Raplamaa", 		  party: 'Info puudub', 			perc: 'N/A' , enabled: true},
	jarva : {loc: new google.maps.LatLng(58.887265,25.569992), name: "JÃ¤rvamaa", 		  party: 'Info puudub',       perc: 'N/A' , enabled: true},
	...
	polva : {loc: new google.maps.LatLng(58.058946,27.066879), name: "PÃµlvamaa", 		  party: 'Info puudub', 			perc: 'N/A' , enabled: true},
	jogeva: {loc: new google.maps.LatLng(58.746387,26.397142), name: "JÃµgevamaa", 	  party: 'Maalaste Erakond' , perc: '100%', enabled: true},
	l_viru: {loc: new google.maps.LatLng(59.348158,26.362381), name: "LÃ¤Ã¤ne-Virumaa", party: 'Info puudub', 			perc: 'N/A' , enabled: true},
	i_viru: {loc: new google.maps.LatLng(59.353726,27.39501),  name: "Ida-Virumaa, ", party: 'Info puudub', 			perc: 'N/A' , enabled: true},
	voru  : {loc: new google.maps.LatLng(57.846213,26.998558), name: "VÃµrumaa",  		  party: 'Info puudub', 			perc: 'N/A' , enabled: true} 
}
...
function updateMarkers() {
    ...
    $("input[type='checkbox']:checked").each(function() {
    	maakond_keskus[$(this).val()].enabled = true;
    })
	initialize();
}
